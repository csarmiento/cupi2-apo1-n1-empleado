...
public class Empleado {
    ...
    /**
     * Retorna la antiguedad del empleado en años.
     *
     * @return Antiguedad del empleado en años.
     */
    ...
    /**
     * Retorna las prestaciones del empleado usando la fórmula: p = (a * s)/12 (p: prestaciones, a: antiguedad, s: salario). <br>
     * La antiguedad que se utiliza está dada en años, así que si un empleado lleva menos de un año en la empresa, sus prestaciones serán 0.
     *
